        ...
        <div class="container">
            <div class="col-left">
                <div class="login-text">
                    <h2>Welcome Admin!</h2>
                    <p>Create your account.<br>For Free!</p> <a href="adRegister.php" class="btn">Sign Up</a>
                </div>
            </div>
            <div class="col-right">
                <div class="login-form">
                    <h2>Login</h2>
                    <form action="adCheck.php" method="post">
                        <p> <label>Username<span>*</span></label> <input type="text" placeholder="Username or Email" name="username" required> </p>
